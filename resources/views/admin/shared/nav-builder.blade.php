...
?>
    ...
    <div class="c-sidebar-brand"><img class="c-sidebar-brand-full" src="{{ asset('assets/brand/logo.png') }}" width="40" height="40" alt="CoreUI Logo"><img class="c-sidebar-brand-minimized" src="{{asset('assets/brand/logo.png')}}" width="40" height="40" alt="CoreUI Logo"></div>
        <ul class="c-sidebar-nav"><br><br>
