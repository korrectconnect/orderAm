...
class ApiController extends Controller
{
    ...
    public function getDistanceRider($order_id, $rider_lat, $rider_long)
    {
        $order_details = OrderLocationDetails::find($order_id);
        ...
        $getVendorDistance = GoogleMaps::getDistance($order_details->vendor_lat, $order_details->vendor_long, $rider_lat, $rider_long);
