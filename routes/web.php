...
*/
   ...
   Route::get('request/test', 'AjaxController@test');
    ...
    Route::group(['middleware' => ['admin'],'prefix' => 'adminredirect'], function() {
        ...
        Route::post('vendor/category', 'AdminAjaxController@addVendorCategory')->name('admin.vendor.category');
        ...
        Route::get('ajax/transaction/filter/{vendor_id}', 'AdminAjaxController@transactionFilter')->name('admin.vendor.transaction.filter.form');
